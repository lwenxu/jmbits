...
function begin_section($title, $toolname, $toolhref, $icon, $color)
{
    echo "
	                        <div class=\"portlet light bordered\">
                                    <div class=\"portlet-title\">
                                        ...
                                        <h3>
                                            ...
                                            <span class=\"caption-subject " . $color . " bold uppercase\">" . $title . "</span>
                                        </h3>
                                        </div>
                                        <div class=\"actions\" style='margin-top: 14px'>
                                            <a class=\"btn btn-circle btn-success\" href=\"" . $toolhref . "\" style='color: white'>
                                                " . $toolname . "
        ...
        <tr style="border: 0px">
            <td colspan="2" style="border: 0px">
                <table cellspacing="1" cellpadding="2" border="0">
                    <tr>
                        <td class="embedded-add"><input class="btn "
                                                        style="font-weight: bold;font-size:11px; margin:7px"
                                                        type="button" name="b" value="B"
                                                        onclick="javascript: simpletag('b')"/></td>
                        <td class="embedded-add"><input class="btn "
                                                        style="font-style: italic;font-size:11px;margin-right:3px"
                                                        type="button" name="i" value="I"
                                                        onclick="javascript: simpletag('i')"/></td>
                        <td class="embedded-add"><input class="btn "
                                                        style="text-decoration: underline;font-size:11px;margin-right:3px"
                        ...
                        ?>
                        <td class="embedded-add"><input class="btn " style="font-size:11px;margin-right:3px"
                        ...
                        <td class="embedded-add"><select class="med btn " style="margin-right:3px" name='color'
                                ...
                                <option style="background-color: darkolivegreen" value="DarkOliveGreen">Dark Olive
                                    Green
                                </option>
                                <option style="background-color: darkgreen" value="DarkGreen">Dark Green</option>
                                <option style="background-color: darkslateblue" value="DarkSlateBlue">Dark Slate Blue
                                </option>
                                <option style="background-color: navy" value="Navy">Navy</option>
                                <option style="background-color: indigo" value="Indigo">Indigo</option>
                                <option style="background-color: darkslategray" value="DarkSlateGray">Dark Slate Gray
                                </option>
                                ...
                                <option style="background-color: mediumturquoise" value="MediumTurquoise">Medium
                                    Turquoise
                                </option>
                                ...
                                <option style="background-color: lemonchiffon" value="LemonChiffon">Lemon Chiffon
                                </option>
                                <option style="background-color: palegreen" value="PaleGreen">Pale Green</option>
                                <option style="background-color: paleturquoise" value="PaleTurquoise">Pale Turquoise
                                </option>
                        ...
                        <td class="embedded-add">
                            <select class="med btn" name='font'
                        ...
                        <td class="embedded-add" style="border: 0px">
                            <select class="med btn " name='size'
...
//	mail rewrite by lwenxu
    ...
    $smtpusermail = $smtp_from; //SMTP服务器的用户邮箱
    $smtpuser = $account_name; //SMTP服务器的用户帐号
    $smtppass = $account_password; //SMTP服务器的用户密码
...
//	}
    ...
    <head>
        ...
        <link rel="search" type="application/opensearchdescription+xml" title="<?php echo $SITENAME ?> Torrents"
              href="opensearch.php"/>
    ...
    <td id="nav_block" class="text" align="center">
        ...
        <!--									class="medium">-->
        <?php //echo $lang_functions['text_welcome_back'] ?><!--, <span-->
        <!--										class="icon-user"></span>-->
        <?php //echo get_username($CURUSER['id']) ?><!-- <span-->
        <!--										class="icon-signout"></span><a-->
        <!--										href="logout.php">-->
        <?php //echo $lang_functions['text_logout'] ?><!--</a>--><?php //if (get_user_class() >= UC_MODERATOR) { ?>
        <!--										<span class="icon-cogs"></span><a-->
        <!--											href="staffpanel.php">-->
        <?php //echo $lang_functions['text_staff_panel'] ?><!--</a> -->
        <?php //} ?><!-- --><?php //if (get_user_class() >= UC_SYSOP) { ?>
        <!--										<span class="icon-wrench"></span><a-->
        <!--											href="settings.php">-->
        <?php //echo $lang_functions['text_site_settings'] ?><!--</a>--><?php //} ?>
        <!--									<span class="icon-star"></span><a-->
        <!--										href="torrents.php?inclbookmarked=1&amp;allsec=1&amp;incldead=0">-->
        <?php //echo $lang_functions['text_bookmarks'] ?><!--</a> <font-->
        <!--										class='color_bonus'>-->
        <?php //echo $lang_functions['text_bonus'] ?><!--</font><span-->
        <!--										class=" icon-pinterest"></span><a-->
        <!--										href="mybonus.php">-->
        <?php //echo $lang_functions['text_use'] ?><!--</a>: --><?php //echo number_format($CURUSER['seedbonus'], 1) ?>
        <!--									<font class='color_invite'>-->
        <?php //echo $lang_functions['text_invite'] ?><!--</font><span-->
        <!--										class="icon-share-alt"></span><a-->
        <!--										href="invite.php?id=--><?php //echo $CURUSER['id'] ?><!--">-->
        <?php //echo $lang_functions['text_send'] ?><!--</a>: --><?php //echo $CURUSER['invites'] ?>
        <!--									<br/>-->
        <!---->
        <!--	<font class="color_ratio">--><?php //echo $lang_functions['text_ratio'] ?><!--</font> -->
        <?php //echo $ratio ?><!-- <font-->
        <!--										class='color_uploaded'>-->
        <?php //echo $lang_functions['text_uploaded'] ?><!--</font> --><?php //echo mksize($CURUSER['uploaded']) ?>
        <!--									<font-->
        <!--										class='color_downloaded'> -->
        <?php //echo $lang_functions['text_downloaded'] ?><!--</font> --><?php //echo mksize($CURUSER['downloaded']) ?>
        <!--									<font-->
        <!--										class='color_active'>-->
        <?php //echo $lang_functions['text_active_torrents'] ?><!--</font><span-->
        <!--										class="icon-circle-arrow-up"-->
        <!--										title="-->
        <?php //echo $lang_functions['title_torrents_seeding'] ?><!--"></span>--><?php //echo $activeseed ?>
        <!--									<span class="icon-circle-arrow-down"-->
        <!--									      title="-->
        <?php //echo $lang_functions['title_torrents_leeching'] ?><!--"></span>--><?php //echo $activeleech ?>
        <!--									&nbsp;&nbsp;<font-->
        <!--										class='color_connectable'>-->
        ...
        <?php //echo $lang_functions['text_the_time_is_now'] ?><!----><?php //echo date('Y-m-d  h:i:sa'); ?>
        <!--									<br/>-->
        <!---->
        <!--									--><?php
...
function genrelist($catmode = 1)
{
    ...
    if (!$ret = $Cache->get_value('category_list_mode_' . $catmode)) {
        $ret = array();
        $res = sql_query("SELECT id, mode, name, image FROM categories ORDER BY sort_index, id") or sqlerr();
        while ($row = mysql_fetch_array($res))
            $ret[] = $row;
            ...
            <div class='portlet-title'>
                <div class='caption'>
                    <h2>
                        ...
                        <span class='caption-subject font-green-steel sbold uppercase'>种子列表 </span>
                    </h2>
                </div>
            </div>
            <div class='portlet-body'>
                ...
                <table class="table table-hover">
                    <tr>
                        ...
                        <td align="center"><a
                                    href="?<?php echo $oldlink ?>sort=1&amp;type=<?php echo $link[1] ?>">标题</a></td>
                        <td align="center"><a
                                    href="?<?php echo $oldlink ?>sort=4&amp;type=<?php echo $link[4] ?>">时间</a></td>
                        <td align="center"><a
                                    href="?<?php echo $oldlink ?>sort=5&amp;type=<?php echo $link[5] ?>">大小</a></td>
                        <td align="center"><a
                                    href="?<?php echo $oldlink ?>sort=7&amp;type=<?php echo $link[7] ?>">种子数</a></td>
                        <td align="center"><a
                                    href="?<?php echo $oldlink ?>sort=8&amp;type=<?php echo $link[8] ?>">下载数</a></td>
                        <td align="center"><a
                                    href="?<?php echo $oldlink ?>sort=6&amp;type=<?php echo $link[6] ?>">完成数</a></td>
                        <td align="center"><a href="?<?php echo $oldlink ?>sort=9&amp;type=<?php echo $link[9] ?>">
                                发布者 </a></td>
                        <?php
                        if (get_user_class() >= $torrentmanage_class) { ?>
                            <td class="" align="center">行为</td>
                        <?php } ?>
                    </tr>
                    <?php
                    $caticonrow = get_category_icon_row($CURUSER['caticon']);
...
//		print(" <font class='label label-success'>".$lang_functions['text_new_uppercase']."</font>");
                        ...
                        if ($CURUSER["bmicon"] == 'yes') {
                            ...
                            $act .= ($act ? "<br><br>" : "") . "<a id=\"bookmark" . $counter . "\" " . $bookmark . " >" . get_torrent_bookmark_state($CURUSER['id'], $id) . "</a>";
                        }
                    ...
                    function get_username($id, $big = false, $link = true, $bold = false, $target = false, $bracket = false, $withtitle = false, $link_ext = "", $underline = false)
                    {
                        static $usernameArray = array();
                        global $lang_functions;
                        $id = 0 + $id;
                        ...
                        if ($arr) {
                            ...
                            $username = ($link == true ? "<a " . $link_ext . " href=\"userdetails.php?id=" . $id . "\"" . ($target == true ? " target=\"_blank\"" : "") . " class='link " . get_user_class_name($arr['class'], true) . "_Name'>" . $username . "</a>" : $username) . $pics . ($withtitle == true ? " (" . ($arr['title'] == "" ? get_user_class_name($arr['class'], false, true, true) : "<span class='" . get_user_class_name($arr['class'], true) . "_Name'><b>" . htmlspecialchars($arr['title'])) . "</b></span>)" : "");
...
";
	...
	";
                    ...
                    function usershare_table($res, $frame_caption, $tooltitle, $toolurl, $icon, $color)
                    {
                        global $lang_topten;
                        global $CURUSER;
                        global $lang_topten;
                        begin_frame('', true);
                        begin_section($frame_caption, $tooltitle, $toolurl, $icon, $color);
                        begin_table();
                        ?>
                        <tr>
                            <td align="left"><?php echo $lang_topten['col_rank'] ?></td>
                            <td align="left"> <?php echo $lang_topten['col_user'] ?> </td>
                            <td align="left"> <?php echo $lang_topten['col_uploaded'] ?> </td>
                            <td align="left"> <?php echo $lang_topten['col_downloaded'] ?></td>
                            <td align="left"> <?php echo $lang_topten['col_ratio'] ?> </td>
                            <td align="left"> <?php echo $lang_topten['col_joined'] ?> </td>
                        </tr>
                        <?php
                        $num = 0;
                        while ($a = mysql_fetch_assoc($res)) {
                            ...
                            $avatar = $a['avatar'] != '' ? $a['avatar'] : 'pic/default_avatar.png';
                            print("<tr>
            <td class=\"rowfollow\" align=\"left\">$num</td><td class=\"rowfollow\" align=\"left\"><img class='img img-circle' style='height: 40px;width: 40px' src=" . $avatar . " > " . get_username($a["userid"]) .
                                "</td><td class=\"rowfollow\" align=\"left\">" . mksize($a["uploaded"]) .
                                "</td><td class=\"rowfollow\" align=\"left\">" . mksize($a["downloaded"]) .
                                "</td><td class=\"rowfollow\" align=\"left\">" . $ratio .
                    ...
                    function _torrenttable($res, $frame_caption, $tooltitle, $toolurl, $icon, $color)
                    {
                        global $lang_topten;
                        begin_frame('', true);
                        begin_section($frame_caption, $tooltitle, $toolurl, $icon, $color);
                        ...
                        ?>
                        <tr>
                            <td align="left" align="center"><?php echo $lang_topten['col_rank'] ?></td>
                            <td align="left"><?php echo $lang_topten['col_name'] ?></td>
                            <td align="left"><?php echo "完成数"; ?></td>
                            <td align="left"><?php echo $lang_topten['col_data'] ?></td>
                            <td align="left"><?php echo $lang_topten['col_to'] ?></td>
                        </tr>
                        <?php
                        $num = 0;
                        while ($a = mysql_fetch_assoc($res)) {
            ...
            <td class=\"rowfollow\" align=\"left\"><a href=\"details.php?id=" . $a["id"] . "&amp;hit=1\">" . $a["name"] . "</a></td>
			<td  align=\"left\">" . number_format($a["times_completed"]) . "</td>
			<td  align=\"left\">" . mksize($a["data"]) . "</td>
			<td  align=\"left\">" . ($a["leechers"] + $a["seeders"]) . "</td>
			</tr>
			");
                        }
                        end_table();
...
<tr><td class=\"sans\">" .
                    ...
                    function bonustable($res, $frame_caption, $tooltitle, $toolurl, $icon, $color)
                    {
                        global $lang_topten;
                        begin_frame('', true);
                        begin_section($frame_caption, $tooltitle, $toolurl, $icon, $color);
                        ...
                        print("<tr><td align=\"left\">" . $lang_topten['col_rank'] . "</td><td align=\"left\">" . $lang_topten['col_username'] . "</td><td align=\"left\">" . $lang_topten['col_bonus'] . "</td></tr>");

                        $n = 1;
                        while ($arr = mysql_fetch_assoc($res)) {
                            //die();
                            print("<tr><td class=\"rowfollow\" align=\"left\">$n</td><td class=\"rowfollow\" align=\"left\">" . get_username($arr["id"]) . "</td><td class=\"rowfollow\" align=\"left\">" . number_format($arr["seedbonus"], 1) . "</td></tr>\n");
                            $n++;
                        }
                    ...
                    function prolinkclicktable($res, $frame_caption, $tooltitle, $toolurl, $icon, $color)
                    {
                        global $lang_topten;
                        begin_frame('', true);
                        begin_section($frame_caption, $tooltitle, $toolurl, $icon, $color);
                    ...
                    function clienttable($res, $frame_caption, $tooltitle, $toolurl, $icon, $color)
                    {
                        global $lang_topten;
                        begin_frame('', true);
                        begin_section($frame_caption, $tooltitle, $toolurl, $icon, $color);
                        ...
                        print("<tr><td align=\"left\">" . $lang_topten['col_rank'] . "</td><td align=\"left\">" . $lang_topten['col_name'] . "</td><td align=\"left\">" . $lang_topten['col_number'] . "</td></tr>");

                        $n = 1;
                        while ($arr = mysql_fetch_assoc($res)) {
                            print("<tr><td  align=\"left\">$n</td><td class=\"rowfollow\" align=\"left\">" . $arr["client_name"] . "</td><td class=\"rowfollow\" align=\"left\">" . number_format($arr["client_num"]) . "</td></tr>");
                            $n++;
                        }
                    ...
                    function supply_snatchtable($res, $frame_caption)
                    {
                        ...
                        <tr>
                            ...
                            <td class="colhead"
                                align="center"> <?php echo $lang_topten['col_torrent_downloaded'] ?> </td>
