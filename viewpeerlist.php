...
if (isset($CURUSER)) {
	function dltable($name, $arr, $torrent)
	{
		...
		$s .= "<tr>
			<td aligen='center' >" . $lang_viewpeerlist['col_user_ip'] . "</td>" .
			"<td aligen='center' width='3%'>" . $lang_viewpeerlist['col_connectable'] . "</td>" .
			"<td aligen='center' >" . $lang_viewpeerlist['col_uploaded'] . "</td>" .
			"<td aligen='center' width=''>" . $lang_viewpeerlist['col_rate'] . "</td>" .
			"<td aligen='center' >" . $lang_viewpeerlist['col_downloaded'] . "</td>" .
			"<td aligen='center' width=''>" . $lang_viewpeerlist['col_rate'] . "</td>" .
			"<td aligen='center' width='4%'>" . $lang_viewpeerlist['col_ratio'] . "</td>" .
			"<td aligen='center' width='4%'>" . $lang_viewpeerlist['col_complete'] . "</td>" .
			"<td aligen='center' >" . $lang_viewpeerlist['col_connected'] . "</td>" .
			"<td aligen='center' >" . $lang_viewpeerlist['col_idle'] . "</td>" .
			"<td aligen='center' >" . $lang_viewpeerlist['col_client'] . "</td></tr>\n";
		$now = time();
		foreach ($arr as $e) {
