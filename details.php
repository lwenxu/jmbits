...
";
        ...
        echo "大小： <span class='label label-success'>$size_info</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分类： <span class='label label-warning'>$type_info</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;二级分类： <span class='label label-warning'>$secondcate</span>";
...
";
        ...
        if ($thanks_said == 0) {
            $buttonvalue = $lang_details['submit_say_thanks'];
            $disable="";
        } else {
            $buttonvalue = $lang_details['submit_you_said_thanks'];
...
//        echo "
//		<ul class=\"pagination\">
//            <li><a onclick=\"saythanks($torrentid,5)\">1</a></li>
//            <li><a onclick=\"saythanks($torrentid,10)\">10</a></li>
//            <li><a onclick=\"saythanks($torrentid,30)\">30</a></li>
//            <li><a onclick=\"saythanks($torrentid,50)\">50</a></li>
//            <li><a onclick=\"saythanks($torrentid,100)\">100</a></li>
//        </ul>
//		";
//		$thanksbutton = "<input class=\"btn btn-success\" type=\"button\" id=\"saythanks\"  onclick=\"saythanks($torrentid);\" " . $buttonvalue . " />";
        $thanksbutton = "<button onclick=\"saythanks($torrentid)\" class='btn btn-success' $disable>$buttonvalue</button>";
