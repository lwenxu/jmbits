...
<b>".$lang_upload['text_chinese_title']."</b>&nbsp;<input type=\"text\" style=\"width: 250px\" name=\"cnname\"><br /><font class=\"medium\">".$lang_upload['text_titles_note']."</font>", 1);
					...
					tr($lang_upload['row_torrent_name'] . "<font color=\"red\">*</font>", "<input placeholder='格式参考：([中文名][英文名][上映时间][清晰度]) 如：银翼杀手 Blade Runner 1982 Final Cut 720p （标题请不要超过13字，下面还有副标题可填写哦：） [必填] ）  ' type=\"text\" class=\"input tip-focus fullwidth\"  id=\"name\" name=\"name\" /><br />", 1);
